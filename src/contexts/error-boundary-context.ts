 ...
 * access to the objects in the error boundary component. The context is used to provide the possibility to use a try-catch block
 * around an async function and correctly throw the error as async functions are not automatically caught by the error boundary.
 *
